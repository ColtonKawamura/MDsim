...
leftWall = [particle.position.x <= particle.diameter / 1.9 for particle in particleList] 
rightWall = [particle.position.x >= 1000 - particle.diameter / 2 for particle in particleList] 
...
forceLaw = forceHookeDamp(k, gamma, box, cl)
